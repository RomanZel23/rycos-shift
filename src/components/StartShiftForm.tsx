...
export function StartShiftForm({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto pb-32 md:pb-20">
      {/* BANER SUKCESU */}
      {successReport ? (
        <div className={`bg-white dark:bg-slate-900 border-2 ${emailWarning ? "border-amber-500" : "border-emerald-500"} rounded-3xl p-6 sm:p-10 shadow-2xl text-center space-y-6 animate-fade-in`}>
          ...
          <div>
            <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white">
              {emailWarning ? "Raport Rozpoczęcia Prac — zapisany, ale nie wysłany" : "Raport Rozpoczęcia Prac Został Wysłany!"}
            </h2>
            <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 mt-2 max-w-xl mx-auto font-medium">
              {emailWarning ? (
                <>
                  Dokument PDF <strong>{successReport.pdfFileName}</strong> został zapisany w archiwum,
                  ale wiadomość e-mail nie wyszła.
                </>
              ) : (
                <>
